...
**Visual comparison of the search strategies for the BFS and A* search algorithms run with the same start and stop (a red icon marks an intersection visited by the algorithm):
